...
function DownloadGbifOrgHorizontal() {
  return (
    <div className="g-min-h-screen g-bg-gradient-to-br g-from-slate-50 g-to-slate-100 g-py-12 g-px-4">
      <div className="g-max-w-7xl g-mx-auto">
        ...
        <div className="g-space-y-6 g-max-w-4xl g-mx-auto">
          {formatCards.map((format) => {
            return (
              <div
                key={format.title}
                className={`g-relative g-bg-white g-rounded g-shadow-lg g-border-2 g-transition-all g-duration-300 hover:g-shadow-2xl ${
                  format.popular
              ...
              >
                {format.popular && (
                  <div className="g-absolute g--top-4 g-left-8">
                ...
                <div className="g-flex g-flex-col lg:g-flex-row">
                  {/* Left section - Main info */}
                  <div className="g-flex-1 g-p-8 lg:g-pr-6">
                    <div className="g-flex g-items-start g-gap-6">
                      <div className="g-flex-1 g-min-w-0">
                        <h3 className="g-text-xl g-font-bold g-text-gray-900 g-mb-3">
                          {format.title}
                        </h3>
                        <p className="g-text-gray-600 g-text-base g-leading-relaxed g-mb-6">
                          {format.description}
                        </p>
                        ...
                        {/* {format.title === 'SIMPLE' && (
                          <div className="g-mb-6 g-p-4 g-bg-amber-50 g-border g-border-amber-200 g-rounded-lg">
                            <div className="g-flex g-items-start g-gap-2">
                              <div className="g-w-5 g-h-5 g-rounded-full g-bg-amber-100 g-flex g-items-center g-justify-center g-flex-shrink-0 g-mt-0.5">
                                <span className="g-text-amber-600 g-text-xs g-font-bold">!</span>
                              </div>
                              <div>
                                <p className="g-text-sm g-font-medium g-text-amber-800 g-mb-1">
                                  Large file size warning
                                </p>
                                <p className="g-text-xs g-text-amber-700 g-leading-relaxed">
                                  This archive is too large to open directly in Excel or similar
                                  applications. You'll need specialized tools like R, Python, or
                                  command-line utilities to handle files of this size.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <Button
                          ...
                          className="g-inline-flex g-items-center g-gap-3 g-py-4 g-px-8"
                        >
                          {/* <Download size={22} /> */}
                  ...
                  <div className="lg:g-w-80 g-bg-gray-50 g-p-8 lg:g-rounded-r-2xl">
                    <h4 className="g-font-semibold g-text-gray-900 g-text-sm g-uppercase g-tracking-wide g-mb-6">
                      What's included:
                    </h4>
                    <ul className="g-space-y-1 g-text-sm">
                      {format.features.map((feature, index) => (
                        <li key={index} className="g-flex g-items-start g-gap-3">
                          {/* <div
                            className={`g-flex-shrink-0 g-rounded-full g-p-1.5 g-mt-0.5 ${
                              format.popular ? 'g-bg-primary-100' : 'g-bg-white'
                            }`}
                          >
                            <Check
                              size={16}
                              className={format.popular ? 'g-text-primary-600' : 'g-text-gray-600'}
                            />
                          </div> */}
                          <span className="g-text-gray-700 g-leading-relaxed">{feature}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
...
export default DownloadGbifOrgHorizontal;
